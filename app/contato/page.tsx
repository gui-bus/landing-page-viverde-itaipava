          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-4 pt-6 border-t border-black/10 dark:border-white/10">
              <div className="flex items-center gap-3 text-sm">
                <MapPin size={18} className="text-[#B88A2D] shrink-0" />
              ...
              <form onSubmit={handleSubmit} className="p-6 sm:p-10 rounded-xl bg-white dark:bg-[#1d211b] border border-black/10 dark:border-white/10 shadow-sm space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-black/10 dark:border-white/10 bg-transparent focus:outline-none focus:border-[#B88A2D] transition-colors text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-black/10 dark:border-white/10 bg-transparent focus:outline-none focus:border-[#B88A2D] transition-colors text-sm resize-none"
                  />
                </div>
                ...
                <p className="text-[11px] text-[#73786e] dark:text-[#a4aa9d] flex items-center gap-2 font-light">
                  <Check size={14} className="text-[#B88A2D]" /> Seus dados estão protegidos. Não enviamos spam.
                </p>
              </form>
            )}
          </div>
